...
declare -a catboost=("0.1.1" "0.1.1.2" "0.1.1.3" "0.1.1.5" "0.1.1.6" "0.1.1.7" "0.1.1.8" "0.1.1.9" "0.2" "0.2.1" "0.2.2" "0.2.4" "0.2.5" "0.3.0" "0.3.1" "0.4.1" "0.5" "0.5.1" "0.5.2" "0.5.2.1" "0.6" "0.6.1" "0.6.1.1" "0.6.2" "0.6.3" "0.7" "0.7.1" "0.7.2" "0.7.2.1", "0.8.1.1", "0.9.1")
